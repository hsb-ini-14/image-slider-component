...
const Slider = () => {
  ...
  return (
    ...
    <div className="relative">
      ...
      <div className="flex gap-x-20 lg:items-start items-center lg:flex-row flex-col">
        ...
        <div className="relative sm:w-[400px] w-[320px] mt-22 lg:mt-5">
          {descriptions.map((desc, i) => (
            <p
              key={i}
              className={`absolute text-centersm:text-xl text-gray-600 transition-all duration-300 ${
      ...
      {/* Controls */}
      <div className="absolute bottom-0 lg:-bottom-20 left-1/2 -translate-1/2 flex gap-x-">
        <button
